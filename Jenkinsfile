      ...
      stages {
        ...
        stage('Docker Build') {
          steps {
            ...
            sh 'docker build -t zamaati/your-py-app:v2 .'
          }
        }
        ...
        stage("Trivy Scan") {
          ...
          steps {
            ...
            script {
              ...
              def dockerImage = "zamaati/your-py-app:v2"
        ...
        stage('Docker Push') {
          steps {
            withCredentials([string(credentialsId: 'dockerhub-pwd', variable: 'dockerhubpwd')]) {
              sh 'docker login -u zamaati -p ${dockerhubpwd}'
              sh 'docker push zamaati/your-py-app:v2'
            }
          }
        }
        ...
        stage('Deploy Container') {
          steps {
            ...
            sh 'docker stop py-app'
            sh 'docker rm py-app'
            sh 'docker run -d --name py-app -p 5000:5000 zamaati/your-py-app:v2'
          }
        }
